    ...
    <div class="tabdata">
        <table>
            ...
            <tr>
                ...
                <td><a href="/interview-scheduler/interview?action=delete&id=${interview.getScheduleId() }"><i  class="fa-solid fa-trash" onclick="return confirm('Do you want to delete this applicant ?')"></i></a></td>
